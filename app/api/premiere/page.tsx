export default function Page() {
  return (
    <main style={{padding: 24}}>
      ...
      <h2>Overview</h2>
      <p>
        This API provides endpoints for managing contacts in the Vendasta CRM system. 
  ...
  "fields": [
    {
      ...
      "operation": "string"     // Optional: "always_overwrite" | "set_if_empty"
    }
  ],
  "searchExisting": ["string"], // Array of field IDs to search for existing contact
  "returnFields": ["string"],   // Array of field IDs to return in response
  "upsertStrategy": "string"    // Optional: "create_if_not_exists" | "update_if_exists" | "create_or_update"
}`}
      </pre>
